...
public class Util {
	...
	public static String getObtenerRutaCarpetas() {
		return "documento" + System.getProperty("file.separator") + Util.getAnioActual()
				+ System.getProperty("file.separator") + Util.getMesActual() + System.getProperty("file.separator")
				+ Util.getDiaActual() + System.getProperty("file.separator");
	}
	...
	public static String getDateyyyyMMddHHmmssSSS(java.util.Date date) {
		if (date == null) {
			return null;
		} else {
